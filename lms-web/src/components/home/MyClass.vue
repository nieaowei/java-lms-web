<template>
    ...
    <el-tabs type="border-card" tab-position="right" :stretch="true">
                    ...
                    <el-card class="data-card" :body-style="{ padding: '0px' }">
                        ...
                        <div style="padding: 14px;">
                            ...
                            <div class="bottom clearfix">
                                ...
                                <el-button v-else icon="el-icon-right" type="primary" class="button" @click="openStudy(classe['name'],classe['dlid'])" >继续学习</el-button>
                            </div>
                        </div>
                    </el-card>
                </el-col>
        ...
        <el-dialog
                ...
                :visible.sync="studyWindow.enable"
                width="70%"
        center>
                <component v-bind:is="this.studyWindow.instance" ></component>
            <span slot="footer" class="dialog-footer">

            <el-button type="primary" v-on:click="studyWindow.enable=false">关 闭</el-button>
                    </span>
        </el-dialog>
    </el-tabs>
